            ...
            <div className={styles.filtruStiri}>
                ...
                <div>
                    ...
                    <div>
                        <br/><h5>Alege zi</h5>
                        <Calendar onChange={(e)=>{
                        console.log("calendar",e.getDate()+'-'+(e.getMonth()+1)+'-'+e.getFullYear());
                        handleFilter(); 
                        setFiltruStiri({...filtruStiri, numarZile:'', perioadaSpecifica:{firstDay:'',lastDay:''}, dataSpecifica:e.getDate()+'-'+(e.getMonth()+1)+'-'+e.getFullYear()})
